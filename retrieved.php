...
try{
$stmt=$conn->prepare("select u.country,m.message,m.sent_at from ".$_SESSION["council"]."_msg m, ".$_SESSION["council"]."_users u where m.recipient= :usr and m.frm=u.username order by sent_at desc ",array(PDO::ATTR_CURSOR=>PDO::CURSOR_SCROLL));
